...
def create_enemy():
    ...
    enemy_rect = pygame.Rect(WIDTH-enemy_width, random.randint(enemy_height, HEIGHT-enemy_height), *enemy.get_size())
...
def create_bonus():
    ...
    bonus_rect = pygame.Rect(random.randint(bonus_width, WIDTH-bonus_width), -bonus_height,  *bonus.get_size())
